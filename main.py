...
def display_instructions(screen):
    ...
    while True:
        ...
        screen.blit(text_instructions_resume, (marge, marge + 70))
        screen.blit(text_instructions_resume2, (marge, marge + 100))
        screen.blit(text_instructions_resume3, (marge, marge + 130))
        screen.blit(text_instructions_resume4, (marge, marge + 160))

        screen.blit(text_instructions_move, (marge, marge + 220))

        screen.blit(text_instructions_ennemy, (marge, marge + 280))

        screen.blit(text_instructions_minotaur1, (marge, marge + 340))
        screen.blit(img_minotaur_scale, (marge, 420))
        screen.blit(text_instructions_minotaur2,(marge, 510))
        screen.blit(text_instructions_minotaur3,(marge, 540))
        screen.blit(text_instructions_minotaur4,(marge, 570))
        screen.blit(text_instructions_minotaur5,(marge, 600))
        screen.blit(text_instructions_minotaur6,(marge, 630))

        screen.blit(text_instructions_siren, (marge + 500, marge + 340))
        screen.blit(img_siren, (marge + 500, 420))
        screen.blit(text_instructions_siren1, (marge + 500, marge + 465))
        screen.blit(text_instructions_siren2, (marge + 500, marge + 495))
        screen.blit(text_instructions_siren3, (marge + 500, marge + 525))
        screen.blit(text_instructions_siren4, (marge + 500, marge + 555))
